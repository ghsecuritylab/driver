...
//#define LCD_PWR_PIN    GET_PIN(D, 12)
#define LCD_DCx_PIN    GET_PIN(D, 12)
#define LCD_RES_PIN    GET_PIN(A, 9)
#define LCD_CSx_PIN    GET_PIN(A, 10)
...
static int rt_hw_lcd_config(void)
{
    ...
    /* config spi */
    {
        ...
        cfg.max_hz = 42 * 1000 * 1000; /* 100M, SPI max 100MHz, lcd 3-wire spi */
...
{
    rt_hw_spi_device_attach("spi1", "spi10",GPIOA,GPIO_PIN_10);
